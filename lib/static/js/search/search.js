        ...
        if(type == "enemies") {
            ...
            for(var i=0; i<drops.length; i++) {
                ...
                if(!missionName.includes("Incursions")) {
                    missionName = `<a href="/missions/${encodeURIComponent(missionName)}" target="#">${missionName}</a>`
                }
            ...
            for(var i=0; i<drops.length; i++) {
                ...
                relicName = `<a href="/relics/${relic.tier}/${relic.name}" target="#">${relicName}</a> ${relicRating}`;
